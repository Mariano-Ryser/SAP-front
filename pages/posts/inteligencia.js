...
const Intelligenz = () => {
  ...
  <section className='section'
   style={{ fontSize: `${gross}` + "rem",
            color: "white"
  }}
   
   >
    <h1>Die Intelligenz</h1>
    <p>La interlicencia se podria de finir de diferentes maneras 
      como porejemplo, la capacidad de logica, comprension pensamiento critico, resolucion de problemas, etc.
      asi como tambien la capacidad de percibir informacion a base de intuicion, y retenerla como conocimiento 
      para aplicarlo a comportamientos adaptativos dentro de un entorno o contexto.
    </p>
    <br></br>
    Muchos creen que el unico medio de aumentar tu inteligencia es el estudio, y pues si, ya que
    es un gran medio para despertar nuestra conciencia y metodos de observacion.
